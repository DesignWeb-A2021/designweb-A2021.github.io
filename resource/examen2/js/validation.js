...
function ValidationNumeroDa(da) {
    ...
    AfficherMessage(inputNoDA, message);
...
function FormulaireEstValide()
{
    ...
    AfficherMessage(declaration, declarationEstCoche ? '' : 'Vous devez accepter la déclaration.')

    let formulaireValide = declarationEstCoche && daEstValide;
